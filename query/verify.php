...
function verify($response) {
    require ("http://www.dev.patentsview.org/querytool/.private/key.php");
...
function save($json) {
    require ("http://www.dev.patentsview.org/querytool/.private/cs.php");
    $ip = $_SERVER["REMOTE_ADDR"]; //server Ip
    ...
    if($statement->execute()){
        ...
        echo json_encode(array("status"=>"success","message"=>"Query Submitted."));
    }else{
        echo json_encode(array("status"=>"error","message"=>"Error Processing Query."));
